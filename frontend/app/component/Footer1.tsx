...
export default function Footer1({
  sectionId = "",
  website = "gdgockaist.com",
  websiteDescription = " Google Developer Group on Campus KAIST",
  handle = "Jiseong Ha",
  classname,
  ...
  function RightSection() {
    return (
      <div className="w-full lg:w-1/2 ">
        <div className="flex flex-wrap gap-8 sm:gap-12 lg:gap-16 xl:gap-20 justify-end">
